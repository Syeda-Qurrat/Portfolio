  ...
  const projects = [
    {
      ...
      description: "A computer vision project that uses OpenCV and MediaPipe to count shoulder press reps in real-time.",
    ...
    },
    {
      ...
      description: "A Python-based system that helps manage and streamline pet adoption using data structures",
    ...
    },
    {
      ...
      description: "A desktop calculator built using Java Swing with light/dark theme switching and basic arithmetic functionality.",
